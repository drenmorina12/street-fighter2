...
export class Ken extends Fighter {
  constructor(playerId, onAttackHit) {
    ...
    this.frames = new Map([
      ...
      // Move Forwards
      ["forwards-1",[[[8, 872, 53, 83],[27, 81]], PushBox.IDLE, HurtBox.FORWARDS]],
      ["forwards-2",[[[70, 867, 60, 88],[35, 86]], PushBox.IDLE, HurtBox.FORWARDS]],
      ["forwards-3",[[[140, 866, 64, 90],[35, 87]], PushBox.IDLE, HurtBox.FORWARDS]],
      ["forwards-4",[[[215, 865, 63, 89],[29, 88]], PushBox.IDLE, HurtBox.FORWARDS]],
      ["forwards-5",[[[288, 866, 54, 89],[25, 87]], PushBox.IDLE, HurtBox.FORWARDS]],
      ["forwards-6",[[[357, 867, 50, 89],[25, 86]], PushBox.IDLE, HurtBox.FORWARDS]],
      ...
      ["backwards-5",[[[782, 865, 58, 91],[36, 88]], PushBox.IDLE, HurtBox.BACKWARDS]],
      ...
      // Crouch
      ["crouch-1",[[[8, 779, 53, 83],[27, 82]], PushBox.IDLE, HurtBox.IDLE]],
      ["crouch-2",[[[79, 794, 57, 69],[25, 66]], PushBox.BEND, HurtBox.BACKWARDS]],
      ...
      ['stun-3', [[[1, 3367, 97, 90], [35, 88]], PushBox.IDLE, [[-22, -91, 28, 18], [-30, -72, 42, 40], [-26, -31, 40, 32]]]],
    ]);
