...
export class Ken extends Fighter {
  constructor({ playerId }) {
    ...
    this.frames = new Map([
      // Idle
      ["idle-1",[[[346, 688, 68, 89],[34, 86]], PushBox.IDLE, [[-8, -88, 24, 16], [-26, -74, 40, 42], [-26, -31, 40, 32]]]],
      ...
      ["backwards-5",[[[782, 865, 58, 91],[36, 88]], PushBox.IDLE]],
      ...
      // Crouch
      ["crouch-1",[[[8, 779, 53, 83],[27, 82]], PushBox.IDLE]],
